 ...
 * neighbourhood. That radio is slow (250 kb/s: a 12-octet message takes 576 µs, longer than any
 * one fragment it sets up, for every mandatory parameter set) but it reaches far and costs almost nothing, which
